# -*- coding: utf-8 -*-
{
    ...
    'summary': 'Portail client pour suivi comptable en temps réel',
    'description': """
Client Portal - ISEB Platform
==============================

Portail client permettant aux entrepreneurs de suivre leur situation
comptable et financière en temps réel.

Fonctionnalités principales
----------------------------
* Dashboard temps réel (trésorerie, CA, charges, résultats)
...
* Dépôt de documents (justificatifs, contrats)
* Simulation d'impôt
